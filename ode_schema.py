...
# Generated 2010-12-17 03:07:44.212416 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:6f60afae-0982-11e0-95f6-940c6de48282')
...
class Joint (RSObject):
    ...
    __World = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'World'), 'World', '__AbsentNamespace0_Joint_World', False)
...
class HingeJoint_ (Joint):
    ...
    # Element World (World) inherited from Joint
...
class Sim_ (RSObject):
    ...
    __Joint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'Joint'), 'Joint', '__AbsentNamespace0_Sim__Joint', True)
...
Joint._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'World'), pyxb.binding.datatypes.string, scope=Joint))
...
Joint._GroupModel_2 = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(Joint._UseForTag(pyxb.namespace.ExpandedName(None, u'World')), min_occurs=1, max_occurs=1),
...
HingeJoint_._GroupModel_3 = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(HingeJoint_._UseForTag(pyxb.namespace.ExpandedName(None, u'World')), min_occurs=1, max_occurs=1),
...
Body_._GroupModel_2 = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(Body_._UseForTag(pyxb.namespace.ExpandedName(None, u'World')), min_occurs=1, max_occurs=1),
...
HingeJoint2_._GroupModel_3 = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(HingeJoint2_._UseForTag(pyxb.namespace.ExpandedName(None, u'World')), min_occurs=1, max_occurs=1),
...
Sim_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Joint'), Joint, scope=Sim_))
...
Sim_._GroupModel_2 = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(Sim_._UseForTag(pyxb.namespace.ExpandedName(None, u'Joint')), min_occurs=0L, max_occurs=None)
    )
